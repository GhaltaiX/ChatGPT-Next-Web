                    ...
                    <>
                      ...
                      >
                        <PasswordInput
                          ...
                          onChange={(e) => {
                            accessStore.update(
                              (access) => (access.openai2ApiKey = e.currentTarget.value),
                            );
                          }}
                        />
                      </ListItem>
                    </>
                  ) : accessStore.provider === "OpenAI3" ? (
                    <>
                      <ListItem
                        title={Locale.Settings.Access.OpenAI.Endpoint.Title}
                        subTitle={Locale.Settings.Access.OpenAI.Endpoint.SubTitle}
                      ...
                      >
                        <PasswordInput
                          ...
                          onChange={(e) => {
                            accessStore.update(
                              (access) => (access.openai3ApiKey = e.currentTarget.value),
                            );
                          }}
                        />
                      </ListItem>
